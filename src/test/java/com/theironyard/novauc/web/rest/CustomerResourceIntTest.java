...
import com.theironyard.novauc.domain.Customer;
import com.theironyard.novauc.repository.CustomerRepository;
...
public class CustomerResourceIntTest {
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getEffectiveStartDate()).isEqualTo(DEFAULT_EFFECTIVE_START_DATE);
    }
    ...
    @Test
    @Transactional
    public void checkEffectiveStartDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setEffectiveStartDate(null);
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getEffectiveStartDate()).isEqualTo(UPDATED_EFFECTIVE_START_DATE);
    }
